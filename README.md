...
Run the project using XAMPP or any local server with PHP and MySQL.
Import the SQL file into your database.
Edit contact.php with your database credentials.
Open index.html in your browser via localhost.
